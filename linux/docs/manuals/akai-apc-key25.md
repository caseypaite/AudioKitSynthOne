...
The knob/button layout is identical to the mk2's, so its annotated diagram
applies here unchanged:

![Akai APC Key 25 mk2 with the 8 knobs and STOP ALL CLIPS/PLAY/RECORD annotated -- identical layout on the original](images/annotated/akai-apc-key25-mk2-annotated.png)
